...
export function PartnersPageClient({
  ...
  return (
    <>
      ...
      {/* ══════════════════════════════════════════════════════════════ */}
      <Section bg="grid" className="bg-background py-24 sm:py-28 lg:py-36">
        <Container>
          <SectionHeading
      ...
      {categories.map((cat, i) => (
        <Section
          key={cat.key}
          className={i % 2 === 1 ? "bg-secondary/15 py-24 sm:py-28 lg:py-36" : "bg-background py-24 sm:py-28 lg:py-36"}
        >
          <Container>
            <PartnerLogoWall
              categoryKey={cat.key}
      ...
      {/*  CTA                                                           */}
      {/* ══════════════════════════════════════════════════════════════ */}
      <Section bg="ambient" className="bg-background pt-28 sm:pt-32 lg:pt-40 pb-28 sm:pb-32 lg:pb-40">
        <Container>
