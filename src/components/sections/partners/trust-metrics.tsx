...
const metrics = [
  { value: 46, suffix: "+", label: "OEM Partners" },
  { value: 100, suffix: "%", label: "Genuine Products" },
  { value: 6, suffix: "", label: "Technology Categories" },
  { value: 15, suffix: "+", label: "Years of Relationships" },
];
...
export function PartnersTrustMetrics() {
