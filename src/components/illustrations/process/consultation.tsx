...
export function ConsultationIllustration({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 120" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Left person */}
      <circle cx={38} cy={44} r={8} fill="none" className="stroke-steel" strokeWidth={1.5} />
      <path d="M26 72 Q 26 60 38 56 Q 50 60 50 72" fill="none" className="stroke-steel" strokeWidth={1.5} />
      {/* Right person */}
      <circle cx={82} cy={44} r={8} fill="none" className="stroke-steel" strokeWidth={1.5} />
      <path d="M70 72 Q 70 60 82 56 Q 94 60 94 72" fill="none" className="stroke-steel" strokeWidth={1.5} />
