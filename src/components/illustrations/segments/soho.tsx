...
export function SohoIllustration({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 120" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x={40} y={40} width={40} height={26} rx={2} fill="none" stroke="var(--steel)" strokeWidth={1.5} />
      <path d="M56 66 L 56 74 M64 66 L 64 74 M48 78 L 72 78" stroke="var(--steel)" strokeWidth={1.5} strokeLinecap="round" />
