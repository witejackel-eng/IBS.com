...
export function NetworkMesh({
  ...
  const edgePositions = useMemo(() => buildEdges(points, 2), [points]);
  ...
  return (
    <group ref={groupRef}>
      <lineSegments>
        ...
        <lineBasicMaterial color="#FDBA74" transparent opacity={0.45} />
      </lineSegments>
      ...
      <mesh>
        ...
        <meshBasicMaterial color="#FED7AA" wireframe transparent opacity={0.25} />
      </mesh>
    </group>
  );
}
