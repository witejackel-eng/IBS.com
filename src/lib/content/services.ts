...
export const services: Service[] = [
  ...
  },
  {
    ...
    body: [
      "Network infrastructure is where most Delhi NCR offices quietly accumulate technical debt. A firewall bought in 2018, a switch added during a floor expansion in 2021, an access point bolted on when Wi-Fi got spotty in the corner office — none of it was planned together, and the cabling documentation stopped being accurate somewhere around the second move. We start every infrastructure engagement with a site survey and a cabling audit, because every later decision (where to put the new rack, which switch port to patch, whether the existing UPS can handle another server) depends on knowing what is actually in the walls.",
