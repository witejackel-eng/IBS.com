/**
 * Every fact in this file is sourced directly from https://ibsinfra.com
 * (operating brand: Insight Business Solutions). Do not add statistics,
 * dates, certifications, or claims that are not present on the source site.
 */
export const company = {
  ...
  about: {
    intro:
      "Insight Business Solutions designs, installs, and supports technology systems for organizations across India. Our engineers handle everything from the first site visit to years of ongoing maintenance.",
    categories: [
      {
