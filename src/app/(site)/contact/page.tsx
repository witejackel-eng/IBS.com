    ...
    <Section className="pt-40">
      <Container>
        ...
        <div className="mt-16 grid grid-cols-1 gap-10 lg:grid-cols-5">
          ...
          <Reveal direction="up" delay={0.15} className="flex flex-col gap-6 lg:col-span-2">
            <div className="rounded-3xl border border-border bg-card p-8">
              <h2 className="text-sm font-semibold tracking-[0.1em] text-steel uppercase">Reach us directly</h2>
